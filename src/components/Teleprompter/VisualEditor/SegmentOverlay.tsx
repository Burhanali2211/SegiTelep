  ...
  return (
    <div
      className={cn(
        ...
        isPlaying && 'border-red-500 bg-red-500/20',
        isSelected && !isPlaying && 'border-yellow-400 bg-yellow-400/15',
        !isSelected && !isPlaying && 'border-green-500 bg-green-500/10',
    ...
    >
      ...
      <div
        className={cn(
          'absolute top-0 left-0 px-2 py-0.5 text-xs font-medium text-black',
